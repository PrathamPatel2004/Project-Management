    ...
    return (
        <div className='max-w-6xl mx-auto'>
            ...
            {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-9">
                <div className="bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition duration-200 rounded-md">
                    <div className="p-6 py-4">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-1"> Members</p>
                                <p className="text-3xl font-bold text-zinc-800 dark:text-white">{invitedTeamMembers.length}</p>
                            </div>
                            <div className="p-3 rounded-xl bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center">
                                <AccountCircleIcon className='size-4 text-blue-500 dark:text-blue-200' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6 py-4">
                        <div className="flex items-start justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-zinc-800 dark:text-white">{projects.filter((p) => p.status !== 'CANCELLED' && p.status !== 'COMPLETED').length}</p>
                            </div>
                            <div className="p-3 rounded-xl bg-emerald-100 dark:bg-emerald-500/10 flex items-center justify-center">
                                <FolderOpenIcon className='size-4 text-emerald-500 dark:text-emerald-200' />
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition duration-200 rounded-md">
                    <div className="p-6 py-4">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-1">Total Members</p>
                                <p className="text-3xl font-bold text-zinc-800 dark:text-white">{teamMembers.length}</p>
                            </div>
                            <div className="p-3 rounded-xl bg-purple-100 dark:bg-purple-500/10 flex items-center justify-center">
                                <AssignmentIcon className='size-4 text-purple-500 dark:text-purple-200' />
                            </div>
                        </div>
                    </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-800">
                                <thead className="bg-gray-50 dark:bg-neutral-900/50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-2.5 text-left font-medium text-sm">Date Invited</th>
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-neutral-400">
                                                {dayjs(member.user?.lastLoggedIn).fromNow() || null}
                                            </p>
                                            <p className="text-sm text-gray-500 dark:text-neutral-400">
                                                {formatDate(member.joinedAt) || null}
                                            </p>
