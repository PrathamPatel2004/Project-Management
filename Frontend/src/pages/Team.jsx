...
function Team() {
    ...
    const filteredUsers = useMemo(() => {
        ...
        return members.filter((member) => member?.user?.name?.toLowerCase().includes(q) || member?.user?.email?.toLowerCase().includes(q));
    }, [members, searchTerm]);
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="relative w-full mt-9">
                ...
                <input
                    ...
                    className="pl-8 w-auto text-sm rounded-md border border-gray-300 dark:border-neutral-800 py-2 focus:outline-none focus:border-blue-500"
                />
            </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-800">
                    <thead>
                        <tr className="bg-gray-50 dark:bg-neutral-900/50">
                            ...
                            <th className="px-6 py-2.5 text-left text-sm">Joined</th>
                        ...
                        {filteredUsers.map((member) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-2.5 text-sm">{member.user.email}</td>
                                    <td className="px-6 py-2.5 text-sm">{dayjs(member.user?.lastLoggedIn).fromNow()}</td>
                                    <td className="px-6 py-2.5 text-sm">{formatDate(member.joinedAt)}</td>
