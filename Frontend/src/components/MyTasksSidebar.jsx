...
function MyTasksSidebar() {
    ...
    return (
        <div className="mt-2 px-3">
            <div onClick={toggleMyTasks} className="flex items-center justify-between px-4 py-2 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-zinc-800" >
                <div className="flex items-center gap-2">
                    <TaskAltIcon className="w-4 h-4 text-gray-500 dark:text-zinc-400" />
                ...
                {showMyTasks ? (
                    <ExpandMoreIcon className="w-4 h-4 text-gray-500 dark:text-zinc-400" />
                ) : (
                    <ExpandLessIcon className="w-4 h-4 text-gray-500 dark:text-zinc-400" />
                )}
            </div>
